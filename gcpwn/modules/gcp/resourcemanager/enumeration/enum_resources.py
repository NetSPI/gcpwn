...
from gcpwn.modules.gcp.resourcemanager.utilities.helpers import (
...
def run_module(user_args, session):
    ...
    allowed_project_ids = normalize_str_set(internal_scope.get("projects", []))
    allowed_folder_ids = normalize_str_set(internal_scope.get("folders", []))
    allowed_organization_ids = normalize_str_set(internal_scope.get("organizations", []))
